...
using Authing.ApiClient.Core.Domain.Exceptions;
using Authing.ApiClient.Core.Domain.Model;
using Authing.ApiClient.Core.Infrastructure.GraphQL;
...
-----END PUBLIC KEY-----";
        ...
        protected BaseClient(string userPoolId, string secret, IAuthingClient client)
        {
        ...
        protected BaseClient(Action<InitAuthenticationClientOptions> init, IAuthingClient client)
        {
            if (init == null)
            {
